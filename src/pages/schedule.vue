  ...
  <v-container>
    ...
    <v-dialog v-model="dialog" max-width="400px">
      <v-card>
        ...
        <v-card-text>
          <v-text-field v-model="eventTitle" label="劇本名稱" @keydown.enter="saveEvent" />
          <v-text-field v-model="eventPlayer" label="玩家名稱" @keydown.enter="saveEvent" />
          <v-text-field v-model="eventChara" label="角色名稱" @keydown.enter="saveEvent" />
          <v-text-field
            v-model="eventTime"
            label="點擊此處選擇時間"
            readonly
