...
async function saveEvent() {
  try {
    ...
    if (selectedEvent.value) {
      ...
      selectedEvent.value.setExtendedProp('player', eventPlayer.value)
      selectedEvent.value.setExtendedProp('chara', eventChara.value)
      selectedEvent.value.setExtendedProp('time', eventTime.value)
    } else {
      // **新增模式**
